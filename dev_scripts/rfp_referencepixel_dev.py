...
rfp_refpix1 = ReferencePixel(meta_data=tmp.meta_referencepixel,
...
# Instantiate rfp referencepixel object.
rfp_refpix2 = ReferencePixel(meta_data=tmp.meta_referencepixel,
...
tmp_class = ReferencePixel(meta_data=tmp.meta_referencepixel,
                file_list=total_noise_files[0],
                outfile=outfile,
                clobber=True)
data = tmp_class.get_data_cube_from_dark_file(total_noise_files[0], skip_first_frame=skip_first_frame)

rfp_refpix3 = ReferencePixel(meta_data=tmp.meta_referencepixel,
                ref_type_data=data,
                outfile=outfile,
                clobber=True)
rfp_refpix3.make_referencepixel_image(tmppath=tmppath, skip_first_frame=skip_first_frame)
...
rfp_refpix4 = ReferencePixel(meta_data=tmp.meta_referencepixel,
                ref_type_data=large_data,
                outfile=outfile,
                clobber=True)
rfp_refpix4.make_referencepixel_image(tmppath=tmppath, skip_first_frame=skip_first_frame)
