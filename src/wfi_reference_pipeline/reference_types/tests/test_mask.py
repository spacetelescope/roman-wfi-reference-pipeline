...
def test_mask_instantiation_with_valid_data(mask_object):
    """
...
def test_mask_instantiation_with_invalid_metadata(valid_ref_type_data):
    """
...
def test_update_mask_ref_pixels(mask_object):
    """
...
def test_populate_datamodel_tree(mask_object):
    """
...
def test_mask_outfile_default(mask_object):
    """
