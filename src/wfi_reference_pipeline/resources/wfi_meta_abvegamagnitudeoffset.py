...
@dataclass
class WFIMetaABVegaMagnitudeOffset(WFIMetadata):
    """
    Class WFIMetaABVegaMagnitudeOffset() Metadata Specific to AB Vega Magnitude Offset Reference File Type
    ...
    def __post_init__(self):
        super().__post_init__()
        self.reference_type = constants.REF_TYPE_ABVEGAMAGNITUDEOFFSET
