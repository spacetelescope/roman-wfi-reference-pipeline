...
@dataclass
class WFIMetaApertureCorrection(WFIMetadata):
    """
    Class WFIMetaApertureCorrection() Metadata Specific to Aperture Correction Reference File Type
    ...
    def __post_init__(self):
        super().__post_init__()
        self.reference_type = constants.REF_TYPE_APERTURECORRECTION
