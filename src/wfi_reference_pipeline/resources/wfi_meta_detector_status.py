...
@dataclass
class WFIMetaDetectorStatus(WFIMetadata):
    """
    Class WFIMetaDetectorStatus() Metadata Specific to Detector Status Reference File Type
    ...
    def __post_init__(self):
        super().__post_init__()
        self.reference_type = constants.REF_TYPE_DETECTORSTATUS
