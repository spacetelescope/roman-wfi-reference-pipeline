...
@dataclass
class WFIMetaLinearity(WFIMetadata):
    """
    Class WFIMetaLinearity() Metadata Specific to Linearity Reference File Type
    ...
    input_units: str
    output_units: str
    # TODO check if you can pass astropy.units rather than str?

    def __post_init__(self):
        super().__post_init__()
        self.reference_type = constants.WFI_REF_TYPES["LINEARITY"]
