...
class DarkQualityControl:
    def __init__(self, rfp_dark, config_path='quality_control_config.yml', check_all=True):
        """
        Initializes the DarkQualityControl object.
    ...
    def qc_checks_notifications(self):
        ...
        If any check is False, then return False, halt delivery.
            ...
            For a failure we need email to RFP  points of contact and a real noticeable slack notification
